...
// Use printInfo method from the newly instantiated wilma(Human) Class
...
console.log(addNames('Greg'))
console.log(addNames('Pele'))
console.log(addNames('Drew'))

// Async JavaScript Section //

// functional programming- using pure functions (return value is based SOLEY on the input)
...
// resolve/reject, result/error, then/catch
